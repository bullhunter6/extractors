...
#keywords: global, EMEA, Middle East, rating trend, rating trends, ratings navigator, rating criteria, sovereign rating history, sukuk, global dashboard, outlook, insurance dashboard, bank dashboard,  Interactive Sovereign Rating Model, 
KEYWORDS = ["global", "EMEA", "Middle East", "rating trend", "rating trends", "rating criteria", "sovereign rating history", "sukuk", "global dashboard", "outlook", "insurance dashboard", "bank dashboard", "Interactive Sovereign Rating Model"]
