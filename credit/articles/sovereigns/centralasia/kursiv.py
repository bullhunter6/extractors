...
sovereign_keywords =[ #removed 
    ...
    'energy sector',"Masdar",'National Fund','ADNOC','green economy','Senate of Uzbekistan',
    ...
    "economic recovery","economic stimulus","economic stimulus package","economic impact","economic contraction","economic indicators","rate cut","investments"
]
...
def sov_kursiv():
    articles = sov_kz_kursiv() + sov_uz_kursiv()
